...
print("="*70)
print("\n💡 Próximos passos:")
print("  1. Adicione mais imagens na pasta 'images/'")
print("  2. Teste queries em português: 'cachorro', 'gato', 'natureza'")
print("  3. Experimente com capturas de tela do seu trabalho")
print("  4. Use metadados para categorizar suas imagens")
print()
